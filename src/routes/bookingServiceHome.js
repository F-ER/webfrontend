...
export default class bookingServiceHome extends Component {
  render() {
    return (
      <div>
        <div>
                  ...
                  <div className="left-page">
                    <div className="form-booking">
                      <form>
                        ...
                        <div className="form-group">
                          <label for="inputState">نوع الغسيل</label>
                          <select className="custom-select form-control">
                            <option selected="">نوع الغسيل</option>
                            <option>نوع الغسيل 1</option>
                            <option>نوع الغسيل 2</option>
                            <option>نوع الغسيل 3</option>
                          </select>
                        </div>
                        <button
                          type="submit"
