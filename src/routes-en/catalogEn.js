...
export default class catalogEn extends Component {
  render() {
    return (
      <div>
        <meta charset="UTF-8" />
          ...
          <div className="data-page">
            <div className="container">
              <div className="bg-inner-page">
                <div className="slider-catelog" dir="ltr">
                  <div className="item-slider-catelog">
                    <img src="assets/images/catalog-slider.png" />
                  </div>
                  <div className="item-slider-catelog">
                    <img src="assets/images/catalog-slider.png" />
                  </div>
